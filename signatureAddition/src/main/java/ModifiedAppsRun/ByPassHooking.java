	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		while(scanner.hasNext())
		{
			...
			//	if(packageCount<129)
				...
				String logPathModifed="/home/nikhil/Documents/apps/logs/"+packageName+"/"+AppLaunchAndDump.deviceIdSynonym[7]+".txt";
				...
				if(!file2.exists())
				{
					System.out.println("File does not exists: "+packageName);
					continue;
				...
				RootDetection.takeDumpOnDevice(AppLaunchAndDump.deviceId[2], AppLaunchAndDump.deviceIdSynonym[7],installationCommand,count,packageName,dumpPathDirectory,originalApkDirectory);
